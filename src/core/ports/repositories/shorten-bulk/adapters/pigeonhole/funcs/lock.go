...
func NewLockFunc(hash string, updatedAt time.Time) func(*shorten_bulk.ShortenBulkRepository) (*repositories.RepositoryDTO[entities.ShortenBulkEntity], error) {
	return func(repository *shorten_bulk.ShortenBulkRepository) (
		*repositories.RepositoryDTO[entities.ShortenBulkEntity],
		...
		err := (*repository).Lock(hash, updatedAt)
		return nil, err
	}
}
